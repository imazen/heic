...
- **Pinned to the unpublished zencodec `caterr-reshape` branch** (rev `2427387f`, PR #116) via `[patch.crates-io]`, plus a `zencodec-testkit` dev-dependency pinned to the same rev (`Cargo.toml`). Drop both once zencodec 0.1.26 + testkit publish.
